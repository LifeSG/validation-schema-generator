import { IFieldSchemaBase, IValidationRule, TFieldSchema } from "../schema-generator";
...
export interface IArrayFieldSchema<V = undefined> extends IFieldSchemaBase<"array-field", V, IArrayFieldValidationRule> {
