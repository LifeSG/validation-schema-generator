...
import { ISectionSchema, RecursivePartial, TComponentSchema, TCustomFieldSchema, TFieldSchema, TSectionsSchema } from "./types";
/**
...
export declare const _testExports: {
    parseWhenKeys: (fieldConfigs: TFieldsConfig<TFieldSchema | TCustomFieldSchema>) => [Record<string, IFieldConfig<TFieldSchema | TCustomFieldSchema>>, [string, string][]];
};
