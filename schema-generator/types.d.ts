...
import { ICheckboxSchema, IChipsSchema, IContactFieldSchema, IDateFieldSchema, IEmailFieldSchema, IImageUploadSchema, IMultiSelectSchema, INestedMultiSelectSchema, INumericFieldSchema, IRadioSchema, ISelectSchema, ISwitchSchema, ITextFieldSchema, ITextareaSchema, ITimeFieldSchema, IUnitNumberFieldSchema } from "../fields";
...
/** field schemas only */
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IChipsSchema<V> | IContactFieldSchema<V> | IDateFieldSchema<V> | IDateRangeFieldSchema<V> | IEmailFieldSchema<V> | IImageUploadSchema<V> | IMultiSelectSchema<V> | INestedMultiSelectSchema<V> | INumericFieldSchema<V> | IRadioSchema<V> | ISelectSchema<V> | ISwitchSchema<V> | ITextareaSchema<V> | ITextFieldSchema<V> | ITimeFieldSchema<V> | IUnitNumberFieldSchema<V>;
