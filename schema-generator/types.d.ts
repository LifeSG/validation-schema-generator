...
import { ICheckboxSchema, IChipsSchema, IContactFieldSchema, IDateFieldSchema, IEmailFieldSchema, IFileUploadSchema, IHistogramSlider, IImageUploadSchema, IMaskedFieldSchema, IMultiSelectSchema, INestedMultiSelectSchema, INumericFieldSchema, IRadioSchema, ISelectSchema, ISliderSchema, ISwitchSchema, ITextFieldSchema, ITextareaSchema, ITimeFieldSchema, IUnitNumberFieldSchema } from "../fields";
...
/** field schemas only */
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IChipsSchema<V> | IContactFieldSchema<V> | IDateFieldSchema<V> | IDateRangeFieldSchema<V> | IEmailFieldSchema<V> | IFileUploadSchema<V> | IHistogramSlider<V> | IImageUploadSchema<V> | IMaskedFieldSchema<V> | IMultiSelectSchema<V> | INestedMultiSelectSchema<V> | INumericFieldSchema<V> | IRadioSchema<V> | ISelectSchema<V> | ISliderSchema<V> | ISwitchSchema<V> | ITextareaSchema<V> | ITextFieldSchema<V> | ITimeFieldSchema<V> | IUnitNumberFieldSchema<V>;
