...
import { IArrayFieldSchema, ICheckboxSchema, IChipsSchema, IContactFieldSchema, IDateFieldSchema, IDateRangeFieldSchema, IESignatureFieldSchema, IEmailFieldSchema, IErrorFieldSchema, IFileUploadSchema, IHistogramSlider, IImageUploadSchema, IMaskedFieldSchema, IMultiSelectSchema, INestedMultiSelectSchema, INumericFieldSchema, IRadioSchema, IRangeSelectSchema, ISelectSchema, ISliderSchema, ISwitchSchema, ITextFieldSchema, ITextareaSchema, ITimeFieldSchema, IUnitNumberFieldSchema, THiddenFieldSchema } from "../fields";
export declare const SCHEMA_TYPES: readonly ["string", "number", "boolean", "array", "object", "mixed"];
export declare const CONDITIONS: readonly ["required", "length", "min", "max", "matches", "email", "url", "uuid", "positive", "negative", "integer", "lessThan", "moreThan", "decimals", "when", "filled", "empty", "equals", "notEquals", "includes", "excludes", "uinfin", "equalsField"];
...
interface IElementSchema extends IBaseElementSchema {
    uiType: "alert" | "text-d1" | "text-d2" | "text-dbody" | "text-h1" | "text-h2" | "text-h3" | "text-h4" | "text-h5" | "text-h6" | "text-body" | "text-bodysmall" | "text-xsmall" | "submit" | "reset" | "divider";
}
...
export interface IWrapperSchema<V = undefined> extends IBaseElementSchema {
    uiType: "div" | "span" | "header" | "footer" | "p" | "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "p" | "accordion" | "grid";
...
/** field schemas only */
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IChipsSchema<V> | IContactFieldSchema<V> | IDateFieldSchema<V> | IDateRangeFieldSchema<V> | IEmailFieldSchema<V> | IErrorFieldSchema | IESignatureFieldSchema<V> | IFileUploadSchema<V> | THiddenFieldSchema<V> | IHistogramSlider<V> | IImageUploadSchema<V> | IMaskedFieldSchema<V> | IMultiSelectSchema<V> | INestedMultiSelectSchema<V> | INumericFieldSchema<V> | IRadioSchema<V> | IRangeSelectSchema<V> | ISelectSchema<V> | ISliderSchema<V> | ISwitchSchema<V> | ITextareaSchema<V> | ITextFieldSchema<V> | ITimeFieldSchema<V> | IUnitNumberFieldSchema<V>;
/**
...
export type TComponentSchema<V = undefined> = TFieldSchema<V> | TCustomFieldSchema<V> | IWrapperSchema | IElementSchema | ICustomComponentSchema;
