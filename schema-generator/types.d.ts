...
import { ICheckboxSchema, IChipsSchema, IContactFieldSchema, IDateFieldSchema, IEmailFieldSchema, IMultiSelectSchema, INumericFieldSchema, IRadioSchema, ISelectSchema, ITextFieldSchema, ITextareaSchema, ITimeFieldSchema, IUnitNumberFieldSchema } from "../fields";
export declare const SCHEMA_TYPES: readonly ["string", "number", "boolean", "array", "object"];
export declare const CONDITIONS: readonly ["required", "length", "min", "max", "matches", "email", "url", "uuid", "positive", "negative", "integer", "lessThan", "moreThan", "when", "filled", "empty", "equals", "notEquals", "includes", "excludes", "uinfin"];
...
interface IElementSchema extends IBaseElementSchema {
    uiType: "alert" | "text-d1" | "text-d2" | "text-dbody" | "text-h1" | "text-h2" | "text-h3" | "text-h4" | "text-h5" | "text-h6" | "text-body" | "text-bodysmall" | "text-xsmall" | "submit" | "reset";
}
...
/** field schemas only */
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IChipsSchema<V> | IContactFieldSchema<V> | IDateFieldSchema<V> | IEmailFieldSchema<V> | IMultiSelectSchema<V> | INumericFieldSchema<V> | IRadioSchema<V> | ISelectSchema<V> | ITextareaSchema<V> | ITextFieldSchema<V> | ITimeFieldSchema<V> | IUnitNumberFieldSchema<V>;
