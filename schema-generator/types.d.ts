...
import { ICheckboxSchema, IChipsSchema, IContactSchema, IDateSchema, IEmailSchema, IMultiSelectSchema, INumericSchema, IRadioSchema, ISelectSchema, ITextSchema, ITextareaSchema, ITimeSchema } from "../fields";
...
interface IElementSchema {
    fieldType: "alert" | "text-d1" | "text-d2" | "text-dbody" | "text-h1" | "text-h2" | "text-h3" | "text-h4" | "text-h5" | "text-h6" | "text-body" | "text-bodysmall" | "text-xsmall" | "div" | "span" | "section" | "header" | "footer" | "p" | "submit";
    validation?: never;
    [otherOptions: string]: unknown;
}
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IChipsSchema<V> | IContactSchema<V> | IDateSchema<V> | IEmailSchema<V> | IMultiSelectSchema<V> | INumericSchema<V> | IRadioSchema<V> | ISelectSchema<V> | ITextareaSchema<V> | ITextSchema<V> | ITimeSchema<V> | IElementSchema;
