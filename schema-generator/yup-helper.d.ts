...
export declare namespace YupHelper {
     ...
     */
    const mapSchemaType: (type: TYupSchemaType) => import("yup/lib/array").OptionalArraySchema<Yup.AnySchema<any, any, any>, import("yup/lib/types").AnyObject, any[]> | Yup.StringSchema<string, import("yup/lib/types").AnyObject, string> | import("yup/lib/mixed").MixedSchema<any, import("yup/lib/types").AnyObject, any> | import("yup/lib/object").OptionalObjectSchema<import("yup/lib/object").ObjectShape, import("yup/lib/object").AnyObject, import("yup/lib/object").TypeOfShape<import("yup/lib/object").ObjectShape>> | Yup.NumberSchema<number, import("yup/lib/types").AnyObject, number> | Yup.BooleanSchema<boolean, import("yup/lib/types").AnyObject, boolean>;
    /**
