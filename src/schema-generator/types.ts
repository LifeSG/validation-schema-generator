...
import { ICheckboxSchema, IEmailSchema, INumericSchema, ITextSchema } from "../fields";
...
export type TFieldSchema<V = undefined> = ICheckboxSchema<V> | IEmailSchema<V> | INumericSchema<V> | ITextSchema<V>;
